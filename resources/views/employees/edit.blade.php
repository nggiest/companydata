        ...
        <div class="col-md-12">
            ...
            <div class="card-body"> 
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_employee" name="name_employee" placeholder="Nama Pegawai" value="{{$employee->name_employee}}">
                ...
                <div class="form-group">
                    ...
                    <select name="id_company" id="id_company" class="form-control select2">
                                            ...
                                            @foreach($company as $pt)
                                                <option name="id_company" id="id_company" value="{{$data = $pt->id}}" {{ $employee->id_company  == $pt->id ? 'selected' : '' }}> {{$pt->name}} </option>
                                            @endforeach
                                        </select>
